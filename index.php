...
<link rel="icon" href="img/iconn.png" type="image" width="100" height="40" />
...
<body>
<div class="mainr">
 <div class="topleft"> <img src="img/Logon.png" width="200" height="60" /></a></div>
...
<div class="downleft">
  ...
  <img src="img/a.png" width="500" height="330"/>
  ...
  <div class="field">
	...
	<div class="free">It's free, Available, and always will be</div>
	<div class="text">
	<form  method="POST">
		...
		<div class="textright">
		  <input type="submit" name="Submit" value="Sign Up" class="greenButton1" />
		 	    ...
		 	    <p><small>&copy;&nbsp; All rights reserved. | <a href="copyright.php">Copyright</a> | <a href="terms.php">Terms and Conditions</a> | <a href="privacyy.php">Privacy Policy</a> | <a class="current" href="about.php">About Us</a></small></p> <b>Brought To You By code-projects.org</b>
</body>
</html>
